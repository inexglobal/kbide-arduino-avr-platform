...
CFLAG="-c -g -Os -std=gnu11 -ffunction-sections -fdata-sections -MMD -fno-fat-lto-objects -mmcu=atmega328 -DF_CPU=16000000L -DARDUINO=18 -Icores/arduino -ID:/KBIDEV2/platforms/arduino-avr/sdk/variants/standard"
CPPFLAG="-c -g -Os -std=gnu++11 -fpermissive -fno-exceptions -ffunction-sections -fdata-sections -fno-threadsafe-statics -Wno-error=narrowing -MMD -mmcu=atmega328 -DF_CPU=16000000L -DARDUINO=18 -Icores/arduino -ID:/KBIDEV2/platforms/arduino-avr/sdk/variants/standard"
ARFLAG=""
